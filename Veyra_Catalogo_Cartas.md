# Veyrá — Catálogo de cartas del set base
...
| Carta | Tipo | Subtipo | Rareza | Costo | ATK/VIDA | Palabras clave | Copias máx. | Set | Imagen esperada |
|---|---|---|---|---|---|---|---|---|---|
| Aprendiz de Kóren | Criatura | — | Soldado (común) | 1 | 2/1 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_aprendiz_de_koren.png` |
| Eco del Primer Templo | Recuerdo | — | Recuerdo | 1 | — | — | 1 (2 con Halvar en el mazo) | Base | `assets/cards/recuerdos/koren_recuerdo_eco_del_primer_templo.png` |
| Recluta de Kóren | Criatura | — | Soldado (común) | 1 | 1/2 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_recluta_de_koren.png` |
| Vendaje de Musgo Antiguo | Hechizo | — | Hechizo | 1 | — | — | 2 | Base | `assets/cards/hechizos/koren/koren_hechizo_vendaje_de_musgo_antiguo.png` |
| Cazador de Kóren | Criatura | — | Soldado (común) | 2 | 1/3 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_cazador_de_koren.png` |
| Escudero de Kóren | Criatura | — | Soldado (común) | 2 | 2/2 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_escudero_de_koren.png` |
| Anciana del Río Callado | Criatura | — | Especialista (poco común) | 3 | 2/4 | — | 2 | Base | `assets/cards/criaturas/koren/koren_criatura_anciana_del_rio_callado.png` |
| Centinela de Kóren | Criatura | — | Soldado (común) | 3 | 2/4 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_centinela_de_koren.png` |
| Lancero de Kóren | Criatura | — | Soldado (común) | 3 | 3/3 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_lancero_de_koren.png` |
| Guardia de Fila de Kóren | Criatura | — | Soldado (común) | 4 | 3/5 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_guardia_de_fila_de_koren.png` |
| Halvar, el que Recuerda | Criatura | — | Héroe (legendaria) | 4 | 3/4 | — | 1 | Base | `assets/cards/criaturas/koren/koren_criatura_halvar_el_que_recuerda.png` |
| Veterano de Kóren | Criatura | — | Soldado (común) | 4 | 4/4 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_veterano_de_koren.png` |
| Bjorna, Madre de las Piedras | Criatura | — | Héroe (legendaria) | 5 | 2/6 | — | 1 | Base | `assets/cards/criaturas/koren/koren_criatura_bjorna_madre_de_las_piedras.png` |
| Campeón de Kóren | Criatura | — | Soldado (común) | 5 | 5/5 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_campeon_de_koren.png` |
| Portador del Estandarte de Kóren | Criatura | — | Soldado (común) | 5 | 4/6 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_portador_del_estandarte_de_koren.png` |
| Coloso de Kóren | Criatura | — | Soldado (común) | 6 | 6/6 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_coloso_de_koren.png` |
| Custodio Menor de Kóren | Criatura | — | Soldado (común) | 6 | 5/7 | — | 3 | Base | `assets/cards/criaturas/koren/koren_criatura_custodio_menor_de_koren.png` |
| El Astado del Valle | Criatura | — | Héroe (legendaria) | 7 | 8/8 | — | 1 | Base | `assets/cards/criaturas/koren/koren_criatura_el_astado_del_valle.png` |

**Texto de reglas:**

- **Eco del Primer Templo:** La próxima criatura este turno cuesta 1 menos. Recuerdo para activar.
- **Vendaje de Musgo Antiguo:** Curá 3 a una criatura o al jugador.
- **Anciana del Río Callado:** Al entrar: curá 2 al jugador. Recuerdo: cura 4.
- **Halvar, el que Recuerda:** Tus cartas de Recuerdo cuestan 0. Mientras Halvar esté en tu mazo, podés incluir 1 copia adicional de Recuerdo.
- **Bjorna, Madre de las Piedras:** Al final de tu turno, curá 2 a tu héroe o a una criatura aliada.
- **El Astado del Valle:** Entra dormido: no puede atacar durante tus dos primeros turnos con él en el campo.

## Caelum

| Carta | Tipo | Subtipo | Rareza | Costo | ATK/VIDA | Palabras clave | Copias máx. | Set | Imagen esperada |
|---|---|---|---|---|---|---|---|---|---|
| Aprendiz de Caelum | Criatura | — | Soldado (común) | 1 | 2/1 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_aprendiz_de_caelum.png` |
| Recluta de Caelum | Criatura | — | Soldado (común) | 1 | 1/2 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_recluta_de_caelum.png` |
| Cazador de Caelum | Criatura | — | Soldado (común) | 2 | 1/3 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_cazador_de_caelum.png` |
| Escudero de Caelum | Criatura | — | Soldado (común) | 2 | 2/2 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_escudero_de_caelum.png` |
| Centinela de Caelum | Criatura | — | Soldado (común) | 3 | 2/4 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_centinela_de_caelum.png` |
| Decreto de Equilibrio | Hechizo | — | Hechizo | 3 | — | — | 2 | Base | `assets/cards/hechizos/caelum/caelum_hechizo_decreto_de_equilibrio.png` |
| Lancero de Caelum | Criatura | — | Soldado (común) | 3 | 3/3 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_lancero_de_caelum.png` |
| Elyon, Juez del Cielo | Criatura | — | Héroe (legendaria) | 4 | 3/5 | Guardián | 1 | Base | `assets/cards/criaturas/caelum/caelum_criatura_elyon_juez_del_cielo.png` |
| Guardia de Fila de Caelum | Criatura | — | Soldado (común) | 4 | 3/5 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_guardia_de_fila_de_caelum.png` |
| Veterano de Caelum | Criatura | — | Soldado (común) | 4 | 4/4 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_veterano_de_caelum.png` |
| Campeón de Caelum | Criatura | — | Soldado (común) | 5 | 5/5 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_campeon_de_caelum.png` |
| Ley de Terra Caelum | Runa | — | Runa | 5 | — | — | 1 | Base | `assets/cards/runas/caelum_runa_ley_de_terra_caelum.png` |
| Portador del Estandarte de Caelum | Criatura | — | Soldado (común) | 5 | 4/6 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_portador_del_estandarte_de_caelum.png` |
| Serena, Tejedora de Leyes | Criatura | — | Héroe (legendaria) | 5 | 2/5 | — | 1 | Base | `assets/cards/criaturas/caelum/caelum_criatura_serena_tejedora_de_leyes.png` |
| Coloso de Caelum | Criatura | — | Soldado (común) | 6 | 6/6 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_coloso_de_caelum.png` |
| Custodio Menor de Caelum | Criatura | — | Soldado (común) | 6 | 5/7 | — | 3 | Base | `assets/cards/criaturas/caelum/caelum_criatura_custodio_menor_de_caelum.png` |
| El Custodio del Anillo | Criatura | — | Héroe (legendaria) | 6 | 3/7 | Guardián | 1 | Base | `assets/cards/criaturas/caelum/caelum_criatura_el_custodio_del_anillo.png` |

**Texto de reglas:**

- **Decreto de Equilibrio:** El maná disponible de ambos se iguala al menor de los dos.
- **Elyon, Juez del Cielo:** Si es atacada como Guardián y sobrevive, gana +1/+1 permanente.
- **Ley de Terra Caelum:** Mientras esté en juego, tu tope de maná máximo pasa a 12.
- **Serena, Tejedora de Leyes:** Mientras esté en el campo, el rival solo puede declarar un ataque por turno.
- **El Custodio del Anillo:** Gana +0/+2 por cada Runa activa en juego (de cualquiera de los dos jugadores).

## Nómadas

| Carta | Tipo | Subtipo | Rareza | Costo | ATK/VIDA | Palabras clave | Copias máx. | Set | Imagen esperada |
|---|---|---|---|---|---|---|---|---|---|
| Aprendiz de Nómadas | Criatura | — | Soldado (común) | 1 | 2/1 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_aprendiz_de_nomadas.png` |
| Recluta de Nómadas | Criatura | — | Soldado (común) | 1 | 1/2 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_recluta_de_nomadas.png` |
| Rumor del Camino | Hechizo | — | Hechizo | 1 | — | — | 2 | Base | `assets/cards/hechizos/nomadas/nomadas_hechizo_rumor_del_camino.png` |
| Cazador de Nómadas | Criatura | — | Soldado (común) | 2 | 1/3 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_cazador_de_nomadas.png` |
| Escudero de Nómadas | Criatura | — | Soldado (común) | 2 | 2/2 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_escudero_de_nomadas.png` |
| Forastero sin Nombre | Criatura | — | Especialista (poco común) | 2 | 3/3 | Oculto | 2 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_forastero_sin_nombre.png` |
| Centinela de Nómadas | Criatura | — | Soldado (común) | 3 | 2/4 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_centinela_de_nomadas.png` |
| Eratiel, el Guerrero sin Historia | Criatura | — | Héroe (legendaria) | 3 | 4/2 | Oculto | 1 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_eratiel_el_guerrero_sin_historia.png` |
| Lancero de Nómadas | Criatura | — | Soldado (común) | 3 | 3/3 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_lancero_de_nomadas.png` |
| Guardia de Fila de Nómadas | Criatura | — | Soldado (común) | 4 | 3/5 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_guardia_de_fila_de_nomadas.png` |
| Senda de los Mil Pasos | Runa | — | Runa | 4 | — | — | 1 | Base | `assets/cards/runas/nomadas_runa_senda_de_los_mil_pasos.png` |
| Vessa, Cartógrafa de Rutas Muertas | Criatura | — | Héroe (legendaria) | 4 | 3/3 | — | 1 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_vessa_cartografa_de_rutas_muertas.png` |
| Veterano de Nómadas | Criatura | — | Soldado (común) | 4 | 4/4 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_veterano_de_nomadas.png` |
| Campeón de Nómadas | Criatura | — | Soldado (común) | 5 | 5/5 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_campeon_de_nomadas.png` |
| Portador del Estandarte de Nómadas | Criatura | — | Soldado (común) | 5 | 4/6 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_portador_del_estandarte_de_nomadas.png` |
| Yesid, el Último Portador | Criatura | — | Héroe (legendaria) | 5 | 3/4 | Oculto | 1 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_yesid_el_ultimo_portador.png` |
| Coloso de Nómadas | Criatura | — | Soldado (común) | 6 | 6/6 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_coloso_de_nomadas.png` |
| Custodio Menor de Nómadas | Criatura | — | Soldado (común) | 6 | 5/7 | — | 3 | Base | `assets/cards/criaturas/nomadas/nomadas_criatura_custodio_menor_de_nomadas.png` |

**Texto de reglas:**

- **Rumor del Camino:** Mirá la próxima carta de tu mazo. Dejala arriba o mandala al fondo.
- **Forastero sin Nombre:** Oculto. Al entrar, sus stats se fijan en secreto: 1/1, 3/3 o 5/1.
- **Eratiel, el Guerrero sin Historia:** Oculto. Sus stats reales se revelan al atacar o ser atacada.
- **Senda de los Mil Pasos:** Mientras esté en juego, tus criaturas Nómadas cuestan 1 menos el turno en que se juegan (mínimo 1).
- **Vessa, Cartógrafa de Rutas Muertas:** Al entrar, mirás las 3 cartas superiores del mazo del rival.
- **Yesid, el Último Portador:** Oculto. Cuando se revela, la próxima carta que juegues este turno cuesta 0.

---

## Contenido de expansión (fuera del set base — no implementado en el motor)

Estas cartas están definidas en `Veyra_Sistema_de_Juego.md` (sección 5) y en `Veyra_Lore_Notas.md`, pero **no existen todavía en `Veyra.html`** — quedan documentadas acá para que el catálogo sea la referencia completa.

| Carta | Facción | Tipo | Costo | Set | Nota |
|---|---|---|---|---|---|
| Piedra de Sigrun | Nómadas | Reliquia | 2 | Expansión | Se transforma en "Sigrun, Runa de la Victoria" si el jugador identifica correctamente a Eratiel o a los Nómadas (Requisito de Recuerdo). |
| Sigrun, Runa de la Victoria | Nómadas | Runa | — (nace de la transformación) | Expansión | Única Runa que rompe la regla de "una por facción". Runa viva — ver Veyra_Lore_Notas.md sección 2.5. |
